package songpatechnicalhighschool.motivation.bluetoothrssi.ui.common;
...
public class Navigation {
    ...
    public void shareFileViaEmail(final Uri fileUri, final String[] recipient, final String subject, final String message) {
        ...
        //startActivity(Intent.createChooser(intent, mActivity.getString(R.string.exporter_email_device_list_picker_text)));
    }
