...
public class FriendFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        profileItemArrayList.add(new ProfileItem(R.mipmap.moonbyul, "문별", "profile 1"));
        profileItemArrayList.add(new ProfileItem(R.mipmap.solar, "솔라", "profile 2"));
        profileItemArrayList.add(new ProfileItem(R.mipmap.wheein, "휘인", "profile 3"));
        profileItemArrayList.add(new ProfileItem(R.mipmap.hwasa, "화사", "profile 4"));
        profileItemArrayList.add(new ProfileItem(R.mipmap.chu, "추세연", "profile 5"));
